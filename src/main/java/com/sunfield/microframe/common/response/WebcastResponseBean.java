...
public class WebcastResponseBean<T> {
    ...
    public WebcastResponseBean(){
        this.status = WebcastResponseStatus.getStatus(WebcastResponseStatus.SUCCESS);
        this.msg = WebcastResponseStatus.getMsg(WebcastResponseStatus.SUCCESS);
    }
